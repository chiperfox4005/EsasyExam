...
<div class="max-w-7xl mx-auto space-y-6 animate-fadeIn" x-data="dashboardApp()">
    ...
    <div class="relative overflow-hidden rounded-3xl shadow-xl">
        ...
        <div class="relative p-8 text-white">
            ...
            <div class="flex gap-3 mt-6">
                <a href="<?php echo e(route('siswa.ujian.daftar')); ?>" class="px-5 py-3 bg-white bg-opacity-20 backdrop-blur-sm border-2 border-white border-opacity-30 rounded-2xl font-semibold hover:bg-opacity-30 transition-all">
                    <i class="fas fa-list mr-2"></i> Daftar Ujian
                </a>
                <a href="<?php echo e(route('siswa.riwayat')); ?>" class="px-5 py-3 bg-white text-blue-600 rounded-2xl font-semibold hover:shadow-xl transition-all">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="group bg-white rounded-3xl p-5 shadow-lg border-2 border-gray-100 hover:border-blue-300 hover:shadow-xl transition-all">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e($totalUjianAktif); ?></p>
        ...
        <div class="group bg-white rounded-3xl p-5 shadow-lg border-2 border-gray-100 hover:border-green-300 hover:shadow-xl transition-all">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e($ujianDikerjakan); ?></p>
        ...
        <div class="group bg-white rounded-3xl p-5 shadow-lg border-2 border-gray-100 hover:border-yellow-300 hover:shadow-xl transition-all">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($rataRataNilai ?? 0, 1)); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="<?php echo e(route('siswa.ujian.daftar')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-semibold flex items-center gap-1">
                    Lihat Semua <i class="fas fa-arrow-right text-xs"></i>
                </a>
            </div>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ujianAktif->count() > 0): ?>
                <div class="space-y-3" id="dashboardActiveExamsList">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ujianAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ujian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="exam-card group border-2 border-gray-200 rounded-2xl p-4 hover:border-blue-400 hover:shadow-lg transition-all bg-gradient-to-r from-white to-blue-50" data-title="<?php echo e(strtolower($ujian->judul)); ?>" data-mapel="<?php echo e(strtolower($ujian->mapel->nama ?? '')); ?>">
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-2 flex-wrap">
                                        <span class="px-2 py-1 text-xs font-bold rounded-full <?php echo e($ujian->mode === 'ujian' ? 'bg-blue-100 text-blue-700 border border-blue-300' : 'bg-green-100 text-green-700 border border-green-300'); ?>">
                                            <?php echo e($ujian->mode === 'ujian' ? '📝 UJIAN' : '📖 LATIHAN'); ?>

                                        </span>
                                        <span class="text-xs text-gray-500 flex items-center gap-1">
                                            <i class="fas <?php echo e($ujian->mapel->icon ?? 'fa-book'); ?> text-blue-500"></i>
                                            <?php echo e($ujian->mapel->nama ?? '-'); ?>

                                        </span>
                                    </div>
                                    <h4 class="font-bold text-gray-900 text-base mb-2 group-hover:text-blue-600 transition-colors search-target-title"><?php echo e($ujian->judul); ?></h4>
                                    <div class="flex items-center gap-4 text-xs text-gray-600 flex-wrap">
                                        <span class="flex items-center gap-1">
                                            <i class="fas fa-list-ol text-purple-500"></i>
                                            <strong><?php echo e($ujian->soalUjian->count()); ?></strong> Soal
                                        </span>
                                        <span class="flex items-center gap-1">
                                            <i class="fas fa-clock text-orange-500"></i>
                                            <strong><?php echo e($ujian->durasi_menit); ?></strong> menit
                                        </span>
                                        <span class="flex items-center gap-1">
                                            <i class="fas fa-calendar text-red-500"></i>
                                            <?php echo e(\Carbon\Carbon::parse($ujian->selesai_at)->format('d M Y')); ?>

                                        </span>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('siswa.ujian.kerjakan', $ujian->id)); ?>" 
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('siswa.riwayat')); ?>" class="text-xs text-blue-600 hover:text-blue-700 font-semibold">
                        Semua
                    </a>
                </div>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($riwayatUjian->count() > 0): ?>
                    <div class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $riwayatUjian->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $riwayat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($riwayat->submitted_at): ?>
                                <a href="<?php echo e(route('siswa.ujian.hasil', $riwayat->id)); ?>" 
                                   class="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
                                    <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 <?php echo e(($riwayat->nilai ?? 0) >= 75 ? 'bg-green-100' : 'bg-red-100'); ?>">
                                        <i class="fas <?php echo e(($riwayat->nilai ?? 0) >= 75 ? 'fa-check text-green-600' : 'fa-times text-red-600'); ?>"></i>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-gray-900 text-sm truncate group-hover:text-blue-600 transition-colors">
                                            <?php echo e($riwayat->ujian->judul ?? 'Ujian'); ?>

                                        </p>
                                        <p class="text-xs text-gray-500">
                                            <?php echo e($riwayat->ujian->mapel->nama ?? '-'); ?> • <?php echo e($riwayat->submitted_at->diffForHumans()); ?>

                                        </p>
                                    </div>
                                    <span class="font-bold text-sm <?php echo e(($riwayat->nilai ?? 0) >= 75 ? 'text-green-600' : 'text-red-600'); ?>">
                                        <?php echo e(number_format($riwayat->nilai ?? 0, 0)); ?>
                            ...
                            <?php else: ?>
                                <div class="flex items-center gap-3 p-3 rounded-xl bg-yellow-50 border border-yellow-200">
                                    ...
                                    <a href="<?php echo e(route('siswa.ujian.kerjakan', $riwayat->id)); ?>" 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const menuItems = [
            { name: 'Dashboard', url: '<?php echo e(route("siswa.dashboard")); ?>', icon: 'home' },
            { name: 'Belajar', url: '<?php echo e(route("siswa.belajar")); ?>', icon: 'book-reader' },
            { name: 'Ujian', url: '<?php echo e(route("siswa.ujian.daftar")); ?>', icon: 'tasks' },
            { name: 'AI Mentor', url: '<?php echo e(route("siswa.ai-mentor")); ?>', icon: 'robot' },
            { name: 'Badge', url: '<?php echo e(route("siswa.badge")); ?>', icon: 'medal' },
            { name: 'Leaderboard', url: '<?php echo e(route("siswa.leaderboard")); ?>', icon: 'trophy' },
            { name: 'Riwayat', url: '<?php echo e(route("siswa.riwayat")); ?>', icon: 'history' },
        ];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\FILE_VSC\EsasyExam\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>