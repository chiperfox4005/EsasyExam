...
<div class="max-w-5xl mx-auto space-y-6 animate-fadeIn" x-data="ujianForm()">
    ...
    <form action="<?php echo e(route('ujian.store')); ?>" method="POST" id="ujianForm" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select name="mapel_id" required class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-2xl">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\EsasyExam\resources\views/ujian/create.blade.php ENDPATH**/ ?>